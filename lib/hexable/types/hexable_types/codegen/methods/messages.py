...
from lib.hexable.types.hexable_types.responses.base_response import DictResponse
from lib.hexable.types.hexable_types.responses.messages import *  # noqa: F401,F403  # type: ignore
...
class MessagesCategory(BaseCategory):
    ...
    async def mark_as_important_conversation(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.markAsImportantConversation", params)
        model = BaseOkResponse
        return model(**response).response
