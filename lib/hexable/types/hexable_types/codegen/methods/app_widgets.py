...
from lib.hexable.types.hexable_types.methods.base_category import BaseCategory
from lib.hexable.types.hexable_types.objects import AppWidgetsPhoto, AppWidgetsPhotos
from lib.hexable.types.hexable_types.responses.app_widgets import *  # noqa: F401,F403  # type: ignore
from lib.hexable.types.hexable_types.responses.base import (
    BaseOkResponse,
    BaseOkResponseModel,
)
...
class AppWidgetsCategory(BaseCategory):
    ...
    async def get_group_image_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("appWidgets.getGroupImageUploadServer", params)
